...
<head>
    ...
    <!-- Css files -->
    <link href="<?php echo base_url('application/css/bootstrap.min.css');?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('application/css/jquery.mmenu.css');?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('application/css/font-awesome.min.css');?>" rel="stylesheet" type="text/css">
    <!--link href="<?php echo base_url('application/css/climacons-font.css');?>" rel="stylesheet" type="text/css"-->
    <link href="<?php echo base_url('application/third_party/jquery-ui/css/jquery-ui-1.10.4.min.css');?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('application/css/style.min.css');?>" rel="stylesheet">
    <!--link href="<?php echo base_url('application/css/add-ons.min.css');?>" rel="stylesheet"-->
    <!--动态加载css-->
    <?php if(!empty($_css)){ ?>
